...
| GitHub security | Repo workflows added, dashboard pending | CodeQL, Dependabot, dependency review, npm audit, and static secret-pattern scanning workflows are committed. Enable GitHub code scanning / Advanced Security and secret scanning push protection where available. |
